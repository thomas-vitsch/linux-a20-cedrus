...
#define SUN4I_TCON0_BASIC1_H_BACKPORCH(bp)		(((bp / 2) - 1) & 0xfff)

#define SUN4I_TCON0_BASIC2_REG				0x50
#define SUN4I_TCON0_BASIC2_V_TOTAL(total)		(((total * 2) & 0x1fff) << 16)
#define SUN4I_TCON0_BASIC2_V_BACKPORCH(bp)		(((bp) - 2) & 0xfff)
...
#define SUN4I_TCON0_LVDS_EVEN_ODD_DIR(enable)		(enable << 29)
#define LVDS_DIR_NORMAL					0
#define LVDS_DIR_REVERSE				1
#define	SUN4I_TCON0_LVDS_ANA0_REG			0x220
#define	SUN4I_TCON0_LVDS_ANA1_REG			0x224
#define ANA0_MAGIC_VAL					0x3f710000
#define ANA1_MAGIC_VAL					0x7c1f7c1f
...
struct sun4i_tcon_quirks {
	/* sun5i has undocumented mux */
	bool				has_unknown_mux;

	/* a33 does not have channel 1 */
	bool				has_channel_1;
};
